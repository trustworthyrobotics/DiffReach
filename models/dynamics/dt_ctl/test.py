...
if __name__ == "__main__":
	...
	ctl_file_dir = cur_file_dir.replace("dynamics", "controllers")
	ctl_model_path = os.path.join(ctl_file_dir, "test.onnx")
	create_model(state_dim, 64, action_dim, False, ctl_model_path)
